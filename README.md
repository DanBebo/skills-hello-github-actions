...
The shell script in the workflow will run whenever a new pull request is opened ![ClipWindowsGIF](https://github.com/user-attachments/assets/5fd79e1f-3edc-463a-b614-1e6bff601efb)
